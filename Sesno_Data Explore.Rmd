...
STXcounts <-
  ...
  select("Species", "BIE","BINE", "BINW", "BISE", "BUT","CBE", "SRA", "SRB", "SRC", "BIZ", "TBW", "THO")
...
gps <- read.csv("Data/GPS Data/GPS_THO_25Jun2022.csv", header=T, na.strings="NA", stringsAsFactors=FALSE)
...
write.csv(gpsMatched,"Data/GPS Data/GPS_THO_25Jun2022_matched2.csv", row.names = TRUE)
