...
STXcounts <-
  ...
  select("Species", "BIE","BINE", "BINW", "BISE", "BUT","CBE", "SRA", "SRB", "SRC")
...
gps <- read.csv("Data/GPS Data/GPS_CBE_19Jun2022.csv", header=T, na.strings="NA", stringsAsFactors=FALSE)
...
gpsMatched <-
  inner_join(resultsforgps, gpsUpdate, by = c("Date","Time"))

#Save CSV file, change name to match date explored
write.csv(gpsMatched,"Data/GPS Data/GPS_CBE_19Jun2022_matched2.csv", row.names = TRUE)
