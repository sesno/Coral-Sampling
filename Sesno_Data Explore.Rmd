...
gps <- read.csv("Data/GPS Data/GPS_CBE_26Jun2022.csv", header=T, na.strings="NA", stringsAsFactors=FALSE)
...
write.csv(gpsMatched,"Data/GPS Data/GPS_CBE_26Jun2022_matched2.csv", row.names = TRUE)
