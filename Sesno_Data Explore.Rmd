...
gps <- read.csv("Data/GPS Data/GPS_BUT_27Jun2022.csv", header=T, na.strings="NA", stringsAsFactors=FALSE)
...
write.csv(gpsMatched,"Data/GPS Data/GPS_BUT_27Jun2022_matched2.csv", row.names = TRUE)
