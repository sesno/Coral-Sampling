...
cdata<-read.csv('Data/Genotype_Samples_2021.csv')
#Change file to match the day that you are looking at
gps_data<-read.csv('Data/GPS Data/GPS_HNB&TEK_16Jul2021.csv')
...
#export csv
write.csv(data_comb,"Data/GPS Data/GPS_HNB&TEK_16Jul2021_Matched.csv", row.names = TRUE)
```
